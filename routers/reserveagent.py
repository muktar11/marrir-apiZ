...
@agent_reserve_router.get("/employer/pending-reserves/employer-request/purchase", status_code=500)
...
@agent_reserve_router.get("/recruiter/pending-reserves/employer-request/purchase", status_code=500)
async def public_test_500():
    """
    Public endpoint that always returns 500.
    """
