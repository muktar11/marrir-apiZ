...
@recruiter_reserve_router.get("/agency/pending-reserves/employer-request/purchase", status_code=500)
...
@recruiter_reserve_router.get("/employeer/pending-reserves/employer-request/purchase", status_code=500)
async def public_test_500():
    """
    Public endpoint that always returns 500.
    """
