...
@recruiter_reserve_router.post("/agency/pending-reserves/employer-request/purchase", status_code=500)
...
@recruiter_reserve_router.post("/employeer/pending-reserves/employer-request/purchase", status_code=500)
async def public_test_500():
    """
    Public endpoint that always returns 500.
    """
...
@recruiter_reserve_router.post("/packages/callback/hyper")
